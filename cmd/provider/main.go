...
import (
	...
	"github.com/crossplane-contrib/provider-jet-github/apis"
	pconfig "github.com/crossplane-contrib/provider-jet-github/config"
	"github.com/crossplane-contrib/provider-jet-github/internal/clients"
	"github.com/crossplane-contrib/provider-jet-github/internal/controller"
)
...
func main() {
	...
	kingpin.FatalIfError(controller.Setup(mgr, log, rl, setup, ws, pconfig.GetProvider(resourceMap), 1), "Cannot setup GitHub controllers")
